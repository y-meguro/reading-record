...
var lint_worker_master_1 = require("./parallel/lint-worker-master");
/*
...
exports.cli = {
    ...
    executeWithParallel: function (cliOptions, files) {
        ...
        if (cliOptions.fix) {
            ...
            var resultsPromise_1 = lint_worker_master_1.lintParallel(files, {
                type: "fix",
                config: config,
        ...
        var resultsPromise = lint_worker_master_1.lintParallel(files, {
            type: "lint",
            config: config,
            concurrency: cliOptions.maxConcurrency
        });
    ...
    executeWithOptions: function (cliOptions, files, text, stdinFilename) {
        ...
        if (cliOptions.fix) {
            // --fix
            var fixEngine_2 = new textfix_engine_1.TextFixEngine(config);
